  ...
  return (
    <div className="md:max-w-xl w-full sm:max-w-md max-w-xs  mx-auto">
      <div className="relative">
        ...
        <input ref={searchRef} onKeyDown={handleSearch} type="search" id="default-search" className="block w-full sm:p-4 sm:pl-10 p-3 pl-9  text-sm text-gray-900 border-2 border-gray-300 rounded-lg bg-gray-50 focus:ring-gray-500 focus:border-gray-500 outline-none" placeholder="Type the news article" required />
